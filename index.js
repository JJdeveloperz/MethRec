...
function readvalue() {
  ...
  if(document.getElementById("read_id").value==""){

  }

  if(document.getElementById("read_password").value==""){
...
if (err) { console.log("Invalid id or password") }
if (xname) {
...
function addvalues(){
  ...
  if(document.getElementById("add_id").value==""){
  ...
  if(document.getElementById("add_password").value==""){
...
function delvalue(){
  ...
  if(document.getElementById("delete_password").value==""){
...
if(document.getElementById("create_confirm_password").value==""){
...
console.log(error);
  ...
  alert("Password & Confirm Passwords Don't Match");
}
